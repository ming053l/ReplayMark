...
ax.text(8.2, 0.865, "dgMARK 3-beam @1% (×1.23 ppl)", color=PRIOR, fontsize=9.5,
        ha="right", va="bottom")
ax.axhline(0.93, color=PRIOR, lw=1.1, ls=":")
ax.text(8.2, 0.935, "KGW δ=1 @1% (×1.03 ppl)", color=PRIOR, fontsize=9.5,
        ha="right", va="bottom")
...
ax.set_title("Detection vs retry budget (held-out, n=30, 512 tokens)", fontsize=11)
fig.tight_layout()
