...
\caption{\textbf{Token-local and model-response watermarking.}
Token-local methods encode the watermark in sampled identities and verify from $y,K$ alone.
Shibboleth encodes it in how a fixed checkpoint responds to keyed context probes, so its
