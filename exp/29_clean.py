...
Same protocol as exp/21; fresh offsets (skip=1400, src_min=700); outputs saved."""
...
prompts = c4_prompts(M.tok, NS, skip=1400, src_min=700)
...
json.dump(dict(sha=sha, gen=GEN, skip=850, pls=pls,
          ...
          open("/ssd1/ming/basinmark/results/29_clean.json", "w"))
